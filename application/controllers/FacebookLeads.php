...
{
    // Esta clase no requiere inicio de sesión
}

class FacebookLeads extends PublicController

{
    ...
    public function webhook() {
        echo "Esta es una respuesta desde miAccion";
    }
...
if ($datosDelPago['name']=='otro') {
    ...
    <Cliente>
       <RazonSocial>F-26 pruebs</RazonSocial>
      <Direccion>GENERICO</Direccion>
         <TipoIdentificacion>02</TipoIdentificacion>
         <NumeroIdentificacion>1000</NumeroIdentificacion>
      ...
      <Detalles>
          <Detalle id="1"> 
              ...
              <SubTotal>40.80</SubTotal>
              <Producto>
                  <Codigo>2</Codigo>
                  <Descripcion>POLLO LIMPIO</Descripcion>
                 <UnidadMedida>lb</UnidadMedida>
                 <ValorUnitario>1.20</ValorUnitario>
              </Producto>
              <Impuestos>
                  <Impuesto>
                      <CodigoImpuesto>01</CodigoImpuesto>
                      <CodigoPorcentaje>00</CodigoPorcentaje>
                      <Porcentaje>0.0</Porcentaje>
                      <BaseImponible>40.80</BaseImponible>
                      <Valor>0.00</Valor>
                 </Impuesto>
              </Impuestos>
          </Detalle>
...
//echo $ProtocoloAutorizacion;
    //return;
    $responseApi['urlqrcode'] = $UrlQRCode;
