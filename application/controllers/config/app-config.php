...
*/
define('APP_ENC_KEY', '17c7f202a69cc02938ba04bdb5081dae');
 ...
 */
define('APP_DB_USERNAME', 'devcorp_ctic');
/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'Panama2023');
/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'devcorp_ctic');
