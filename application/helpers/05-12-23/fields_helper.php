 ...
 * @param array  $options         Opciones del select (array asociativo de value => label).
 * @param string $selected_value  Valor seleccionado.
 * @param array  $select_attrs    Atributos adicionales del select.
 * @param array  $form_group_attr Atributos adicionales del grupo de formulario.
 * @param string $form_group_class Clases adicionales del grupo de formulario.
 *
 * @return string HTML renderizado del campo de tipo select.
 */
function render_selectOperadorV($name, $label = '', $options = [], $selected_value = '', $select_attrs = [], $form_group_attr = [], $form_group_class = '')
{
    $select = '';
    $_select_attrs = '';
    ...
    $select .= '<select id="' . $name . '" name="' . $name . '" class="form-control" ' . $_select_attrs . '>';
    foreach ($options as $value => $option_label) {
        $selected = ($selected_value == $value) ? 'selected' : '';
        $select .= '<option value="' . $value . '" ' . $selected . '>' . $option_label . '</option>';
    }
    $select .= '</select>';
    $select .= '</div>';
