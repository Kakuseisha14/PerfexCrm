...

{
    ...
    {
        // Ajusta el nombre de la tabla y el prefijo según tu estructura de base de datos
        $this->db->from(db_prefix() . 'cajasSucursales');
    
        // Específicamente selecciona el campo 'caja'
        $this->db->select('caja as description, idSucursal as long_description');
    ...
    {
        // Ajusta el nombre de la tabla y el prefijo según tu estructura de base de datos
        $this->db->from(db_prefix() . 'sucursal');
    
        // Específicamente selecciona el campo 'caja'
        $this->db->select('sucursal as description');
    ...
    public function addCaja($data)

    {



        $this->db->insert('tblcajasSucursales', $data);
        ...
        if ($insert_id) {
           ...
           // handle_custom_fields_post($insert_id, $custom_fields, true);
            ...
            log_activity('New Invoice Item Added [ID:' . $insert_id . ', ' . $data['caja'] . ']');
...

    {
        ...
        $this->db->insert('tblsucursal', $data);
        ...
        if ($insert_id) {
           ...
           // handle_custom_fields_post($insert_id, $custom_fields, true);
            ...
            log_activity('New Invoice Item Added [ID:' . $insert_id . ', ' . $data['sucursal'] . ']');
...

    {
        ...
        $this->db->update('tblcajasSucursales', $data);
        ...
        if ($updated) {
            ...
            log_activity('Invoice Item Updated [ID: ' . $itemid . ', ' . $data['caja'] . ']');
...

    {
        ...
        $this->db->update('tblsucursal', $data);
        ...
        if ($updated) {
            ...
            log_activity('Invoice Item Updated [ID: ' . $itemid . ', ' . $data['sucursal'] . ']');
...

    {
        ...
        $this->db->delete(db_prefix() . 'cajasSucursales');
