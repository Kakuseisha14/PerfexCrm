                ...
                <div class="row">
                    ...
                    <div class="col-md-<?php echo !isset($client) ? 12 : 8; ?>">
                     ...
                     ?>
                        ...
                        /*
if (!empty($ubicaionesSatcom)) { ?>
   <div class="form-group select-placeholder">
       <label for="ubicaionesSatcomUbicaiones" class="control-label">Ubicaiones (Provincia - Distrito - Corregimientos)</label>
       <select name="ubicaionesSatcomUbicaiones" id="ubicaionesSatcomUbicaiones" class="form-control selectpicker" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
           <option value="">Seleccione</option>
           <?php foreach ($ubicaionesSatcom as $ubicacion) {
               $selected = '';
               if (isset($client) && $client->ubicaionesSatcom == $ubicacion['PROVINCIA']) {
                   $selected = 'selected';
               }
           ?>
           <option value="<?php echo $ubicacion['CODIGO_UBICACION']; ?>" <?php echo $selected; ?>><?php echo $ubicacion['PROVINCIA']; ?> - <?php echo $ubicacion['DISTRITO']; ?> - <?php echo $ubicacion['CORREGIMIENTO']; ?></option>
           <?php } ?>
       </select>
   </div>
<?php }*/ ?>
...
if (!empty($ubicaionesSatcom)) { ?>
   <div class="form-group select-placeholder">
       <label for="ubicaionesSatcomProvincias" class="control-label">Provincias</label>
       <select name="ubicaionesSatcomProvincias" id="ubicaionesSatcomProvincias" class="form-control selectpicker" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
           <option value="">Seleccione</option>
           <?php foreach ($ubicaionesSatcom as $ubicacion) {
               $selected = '';
               if (isset($client) && $client->ubicaionesSatcom == $ubicacion['PROVINCIA']) {
...
if (!empty($ubicaionesSatcom)) { ?>
   <div class="form-group select-placeholder">
       <label for="ubicaionesSatcomDistritos" class="control-label">Distritos</label>
       <select name="ubicaionesSatcomDistritos" id="ubicaionesSatcomDistritos" class="form-control selectpicker" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
           <option value="">Seleccione</option>
           <?php foreach ($ubicaionesSatcom as $ubicacion) {
               $selected = '';
               if (isset($client) && $client->ubicaionesSatcom == $ubicacion['DISTRITO']) {
                   $selected = 'selected';
               }
           ?>
           <option value="<?php echo $ubicacion['CODIGO_DISTRITO']; ?>" <?php echo $selected; ?>><?php echo $ubicacion['DISTRITO']; ?></option>
           <?php } ?>
       </select>
   </div>
<?php } ?>
                        ...
                        <?php  /* if(!empty($ubicaionesSatcom)) { ?>
                            <pre>
                                <?php var_dump($ubicaionesSatcom); ?>
                            </pre>
                        <?php }*/ ?>
 ...
 if (!empty($ubicaionesSatcom)) { ?>
    <div class="form-group select-placeholder">
        <label for="ubicaionesSatcom" class="control-label">Corregimientos</label>
        <select name="ubicaionesSatcom" id="ubicaionesSatcom" class="form-control selectpicker" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
            <option value="">Seleccione</option>
            <?php foreach ($ubicaionesSatcom as $ubicacion) {
                $selected = '';
                if (isset($client) && $client->ubicaionesSatcom == $ubicacion['CORREGIMIENTO']) {
                    $selected = 'selected';
                }
            ?>
            <option value="<?php echo $ubicacion['CODIGO_CORREGIMIENTO']; ?>" <?php echo $selected; ?>><?php echo $ubicacion['CORREGIMIENTO']; ?></option>
            <?php } ?>
        </select>
    </div>
<?php } ?>
