...
<div class="panel_s invoice accounting-template">
    ...
    <div class="form-group select-placeholder">
        ...
        <select id="sel_city" class="selectpicker" data-width="100%" name="provincia" data-none-selected-text="-- Select city --">
...
<div class="col-md-6">
    <div class="form-group select-placeholder">
        ...
        <select id="sel_depart" class="selectpicker" data-width="100%" name="distrito" data-none-selected-text="-- Select city --">
...
<div class="col-md-6">
    <div class="form-group select-placeholder">
        ...
        <select id="sel_user" class="selectpicker" data-width="100%" name="corregimiento" data-none-selected-text="-- Select city --">
    ...
    <div class="form-group select-placeholder">
        ...
        <select id="sel_sucursal" class="selectpicker" data-width="100%" name="sucursal" data-none-selected-text="-- Select city --">
        <option value="">Seleccione</option>
...
<div class="col-md-6">
    <div class="form-group select-placeholder">
        ...
        <select id="sel_caja" class="selectpicker" data-width="100%" name="caja" data-none-selected-text="-- Select city --">
