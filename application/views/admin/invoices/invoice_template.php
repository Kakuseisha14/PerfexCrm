...
<div class="panel_s invoice accounting-template">
            ...
            if (!isset($invoice_from_project)) { ?>
               ...
               ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group select-placeholder">
                            <label for="sel_city" class="control-label">Provincias</label>
                            <select id="sel_city" class="selectpicker" data-width="100%" name="provincia"
                                data-none-selected-text="-- Select city --">
                                <option value="">Seleccione</option>
                                <?php foreach($cities as $city): ?>
                                <option value="<?= $city['id_provincia'] ?>"><?= $city['provincias'] ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group select-placeholder">
                            <label for="sel_depart" class="control-label">Distrito</label>
                            <select id="sel_depart" class="selectpicker" data-width="100%" name="distrito"
                                data-none-selected-text="-- Select city --">
                    ...
                    <div class="col-md-6">
                        <div class="form-group select-placeholder">
                            <label for="sel_user" class="control-label">Corregimiento</label>
                            <select id="sel_user" class="selectpicker" data-width="100%" name="corregimiento"
                                data-none-selected-text="-- Select city --">
                  ...
                  if (isset($invoice)) {
                   ...
                   ?>
                    ...
                    $id_sucursal=get_staff_sucursal_id();
                    //echo $id_sucursal;

                    $caja=get_staff_caja_name();
                    //echo $caja;
                    
                    
                    $id_caja=get_staff_caja_id();
                    //echo $id_caja;
                ...
                ?>
                    ...
                    <div class="col-md-6">
                        <div class="form-group select-placeholder">
                            ...
                            <select  id="sel_sucursal" class="selectpicker" data-width="100%" name="sucursal"
                                data-none-selected-text="-- Select city --">
                                <option value="">Seleccione</option>
                                <?php 
                                
                                $id_sucursal_array = explode(', ', $id_sucursal);

                                foreach($sucursales as $sucursal): ?>

                               

                                    <?php if (in_array($sucursal['id'], $id_sucursal_array)) { 
                    ...
                    <div class="col-md-6">
                        <div class="form-group select-placeholder">
                            ...
                            <select  id="sel_caja" class="selectpicker" data-width="100%" name="caja"
                                data-none-selected-text="-- Select city --">

                                <option  value="<?= $id_caja ?>"><?= $nombreSucursal ?> -- <?= $caja ?></option>
                            </select>
                        </div>
                    </div>
    ...
    <!--Codigo para Dynamic Dependent Dropdown with Ajax-->
    <!-- City 
        ...
        <td>
            <select id='sel_citys'>
                ...
                foreach($cities as $city){
                    ...
                    echo "<option value='".$city['id']."'>".$city['provincias']."</option>";
                }
                ?>
            </select>
        </td>
