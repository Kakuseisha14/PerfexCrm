...
<div id="wrapper">
    ...
    echo ' PDF';
                     ...
                     if (!empty($datos_dgi)) {
                        ...
                        echo 'El array $datos_dgi está vacío.';
                    }*/
                     if ($datos_dgi) {
...
href="<?php echo admin_url('payments/pdfDgi/' . $payment->paymentid  . '?output_type=I'); ?>"

target="_blank"><?php echo _l('view_pdf_dgi'); ?></a></li> <?php 
