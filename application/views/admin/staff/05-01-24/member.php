...
<div id="wrapper">
    ...
    echo ' hide';
                        ...
                        <div class="form-group select-placeholder">
                            ...
                            <select id="sel_sucursal" class="selectpicker" data-width="100%" name="id_sucursal"
                                ...
                                <option  <?php if (isset($member) && $member->id_sucursal==$sucursal['id'] ) {
                                        ?>  selected <?php   }
                    ...
                    <div class="col-md-6">
                        <div class="form-group select-placeholder">
                            ...
                            <select id="sel_caja" class="selectpicker" data-width="100%" name="id_caja"
                                data-none-selected-text="-- Select city --">

                                <option value="">Seleccione</option>
                                <?php if ($member->id_sucursal) {
                                        ?>
                                
                                    <option selected value="<?= $member->id_caja ?>"><?= $member->caja ?></option>
                                    <?php   }
                                    ?>
                            </select>
                        </div>
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $.each(response, function(index, data) {
                    options += '<option value="' + data['id'] + '">' + data[
                        'caja'] + '</option>';
                });
