...
<div id="wrapper">
    ...
    echo ' hide';
                        ...
                        <div class="form-group select-placeholder">
                            ...
                            <select class="selectpicker" id="sel_sucursal" name="id_sucursal[]" data-none-selected-text="-- Select city --"
                            ...
                            <option <?php if (isset($member)  && in_array($sucursal['id'], $id_sucursal_array)) { echo 'selected'; } ?> value="<?= $sucursal['id'] ?>"><?= $sucursal['sucursal'] ?></option>
                            <?php endforeach; ?>
                    ...
                    <div class="col-md-6">
                        <div class="form-group select-placeholder">
                            <label for="sel_caja" class="control-label">Caja</label>
                                ...
                                <select class="selectpicker" id="sel_caja" name="id_caja[]" data-none-selected-text="-- Select city --"
                            data-toggle="<?php echo $this->input->get('allowed_payment_modes'); ?>"
                             data-actions-box="true" multiple="true" data-width="100%"
                            data-title="<?php echo _l('dropdown_non_selected_tex'); ?>">
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $.each(response, function(index, data) {
                    options += '<option value="' + data['id'] + '">' + data['sucursal'] + ' -- ' + data[
                        'caja'] + '</option>';
                });
