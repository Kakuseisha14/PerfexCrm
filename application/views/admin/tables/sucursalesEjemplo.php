...
foreach ($rResult as $aRow) {
    ...
    if (has_permission('items', '', 'delete')) {
        $descriptionOutput .= ' | <a href="' . admin_url('sucursal/delete/' . $aRow['id']) . '" class="text-danger _delete">' . _l('delete') . '</a>';
    }

    /*if (has_permission('items', '', 'create')) {
        $descriptionOutput .= ' | <a href="' . admin_url('sucursal/copy/' . $aRow['id']) . '" class=" _edit_item">' . _l('copy') . '</a>';
    }*/
