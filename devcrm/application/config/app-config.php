...
*
*/
define('APP_BASE_URL', 'https://dev.corpdev.dev/');
...
*/
define('APP_ENC_KEY', '355012b150a53f89e3e16604c9acc4c8');
 ...
 */
define('APP_DB_USERNAME', 'devcorp_crmcorpsrvr');
/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'FI4Q%aizP[c.');
/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'devcorp_crmdev');
