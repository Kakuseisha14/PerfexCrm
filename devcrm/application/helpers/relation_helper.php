...

{
    ...
    if ($type == 'customer' || $type == 'customers') {
        ...
        if ($q) {
            ...
            $where_provincias = 'provincias.provincias LIKE "%' . $CI->db->escape_like_str($q) . '%" ESCAPE \'!\'';

// Asegúrate de reemplazar "nombre_de_tu_tabla" con el nombre real de la tabla de clientes
$where_provincias .= ' AND ' . db_prefix() . 'provincias.active = 1';

// Agrega este fragmento a tu consulta general donde la necesites
$where_clients .= $where_provincias;
